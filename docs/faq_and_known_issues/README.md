...
**How to check:** just browse wsshdict log (/var/log/wsshdict/wsshdict.log). It the client faces the issue, the log has entries like:
...
2. Modify data_size directive of the /etc/imunify360-webshield/webshield-shdict.conf config file to 22020096 (21 MB in bytes: 1024*1024*21)

3. Restart imunify360-webshield:
<div class="notranslate">
 ```
 systemctl restart imunify360-webshield | service imunify360-webshield reload
 ```
 </div>
